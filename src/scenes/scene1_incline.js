...
export class Scene1Incline extends BaseScene {
  ...
  update() {
    ...
    obj.mesh.quaternion.copy(getRampFrameQuaternion(this.inclineData));
  ...
  getTelemetry() {
    ...
    const netAlong = forces.net;
    const netVec = {
      x: alongUnit.x * netAlong,
      y: alongUnit.y * netAlong,
      z: alongUnit.z * netAlong,
    };
